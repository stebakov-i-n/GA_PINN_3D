...
clearml-task --project kornaeva-rnf/GA_PINN_3D --name ga_pinn_3d --script main.py --queue e0841e72c8a544efa9c54b5e768b1683 --docker "pytorch/pytorch:2.10.0-cuda12.6-cudnn9-devel" --requirements "req.txt" --folder '' --skip-task-init --docker_bash_setup_script setup.sh
